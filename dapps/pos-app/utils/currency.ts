...
// Same formatter as the payment page and the receipt email, so a token amount
// reads the same everywhere: 2-6 decimals, "≈" only when digits were cut.
export { formatTokenAmount } from "@walletconnect/pay-core";
