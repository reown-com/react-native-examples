...
export default function useWalletKitEventsManager(initialized: boolean) {
  ...
  useEffect(() => {
    if (initialized && walletKit) {
      ...
      //         params: [
      //           {
      //             data: '0xa9059cbb00000000000000000000000013a2ff792037aa2cd77fe1f4b522921ac59a9c5200000000000000000000000000000000000000000000000000000000002dc6c0',
      //             from: '0x13A2Ff792037AA2cd77fE1f4B522921ac59a9C52',
      //             to: '0x0b2c639c533813f4aa9d7837caf62653d097ff85',
      //           },
      //         ],
      //         expiryTimestamp: 1733476442,
      //       },
      //       chainId: 'eip155:10',
      //     },
      //     verifyContext: {
